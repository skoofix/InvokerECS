...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Orb.ActiveOrbs activeOrbs { get { return (Code.Gameplay.Features.Orb.ActiveOrbs)GetComponent(GameComponentsLookup.ActiveOrbs); } }
    ...
    public GameEntity AddActiveOrbs(System.Collections.Generic.List<Code.Gameplay.Features.Orb.OrbTypeId> newValue) {
        ...
        var component = (Code.Gameplay.Features.Orb.ActiveOrbs)CreateComponent(index, typeof(Code.Gameplay.Features.Orb.ActiveOrbs));
